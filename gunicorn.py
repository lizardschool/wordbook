...
bind = "unix:/var/run/wordbook.sock"     # Or "unix:/tmp/gunicorn.sock"
daemon = False            # Whether work in the background
debug = True              # Some extra logging
keepalive = 5             # Time we wait for next connection (in seconds)
logfile = '/var/log/wordbook-gunicorn.log'               # Name of the log file
loglevel = "info"         # The level at which to log
pidfile = '/var/run/wordbook-gunicorn.pid'              # Path to a PID file
